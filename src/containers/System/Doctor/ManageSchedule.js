...
class ManageSchedule extends Component {
    constructor(props){
       ...
       componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if(prevProps.allScheduleTime !== this.props.allScheduleTime){
            ...
            // console.log('check rangeTime data',data)
            this.setState({
                rangeTime: data
            })
        }
  ...
  handleSaveSchedule = async () => {
    ...
    if (res && res.errCode === 0 ){
        ...
        console.log('Save Info failed', res)
    }
    ...
    render() {
    // console.log(' hoi tao di may check state',this.state)
    // console.log(' hoi tao di may check props',this.props)
    // console.log (' check rang time',rangeTime)
      let {rangeTime} = this.state;
      let {language} = this.props;
